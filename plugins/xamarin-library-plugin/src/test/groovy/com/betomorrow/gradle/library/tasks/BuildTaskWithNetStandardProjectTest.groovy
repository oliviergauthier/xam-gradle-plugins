...
class BuildTaskWithNetStandardProjectTest extends Specification {
    ...
    def setup() {
        project = ProjectBuilder.builder().withProjectDir(new File('src/test/resources/CrossNetStandardLib')).build()
    ...
    def "should run xbuild"() {
        ...
        1 * xBuild.buildCrossLibrary('Release', "CrossNetStandardLib.sln")
    }
